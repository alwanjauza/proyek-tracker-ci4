                    ...
                    <div class="card-body">
                        ...
                        <form id="validateForm" action="<?= site_url('/project/validate/' . $ajuan['id_ajuan']); ?>" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input style="color: black;"  type="text" class="form-control <?= (session()->getFlashdata('errors')['nama_aplikasi'] ?? '') ? 'is-invalid' : '' ?>" id="nama_aplikasi" name="nama_aplikasi" value="<?= $ajuan['nama_aplikasi']; ?>" disabled>
